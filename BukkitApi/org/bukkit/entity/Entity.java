...
public interface Entity extends Metadatable, CommandSender, Nameable {
    ...
    /**
     * 离开当前的车辆. 如果实体当前在载具中(并从中移除), 则返回true, 否则将返回false.
     * <p>
 	 * 原文:
    ...
    /**
     * 获取此实体可以使用门户网站之前的时间段（以刻度表示）。<b>谷歌翻译的, 没用过也不知道什么意思,还请大佬亲自来改</b>     
     * <p>
 	 * 原文:
