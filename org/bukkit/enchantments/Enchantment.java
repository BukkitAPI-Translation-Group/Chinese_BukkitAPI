...
public abstract class Enchantment {
    ...
    /**
     * 附魔：精准采集
     * 原文：Allows blocks to drop themselves instead of fragments (for example,
    ...
    /**
     * 得到这个附魔所支持的 物品 {@link ItemStack}. <p>
     * 原文：Gets the type of {@link ItemStack} that may fit this Enchantment.
     *
     * @return 这个附魔的目标物品.
     */
    ...
    /**
     * 得到所有已经注册了的附魔. <p>
     * 原文：Gets an array of all the registered {@link Enchantment}s
     *
     * @return 一个数组
     */
